...
urlpatterns = [
    ...
    path('insert_cart/<int:id>/<int:x>',views.insert_into_cart,name='insert_cart'),
    path('cart/update_item/<int:id>/<str:action>/<int:x>',views.update_item_quantity,name='update_item'),
    ...
    path('insert/database/',views.InsetDatabase.as_view(),name='inserting'),
]